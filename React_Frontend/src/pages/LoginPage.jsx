                ...
                <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-slate-400 mt-2 text-sm">
                            Log in to access your product management dashboard.
                        </p>
                    </div>
                        ...
                        <div>
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className="w-full pl-10 pr-4 py-2.5 bg-slate-900/50 border border-white/10 rounded-xl focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500/50 outline-none transition-all text-slate-200 placeholder:text-slate-600"
